...
with open('../unilm/beit3/outputs/submit_vqav2_val1000_large_itc.json', 'r') as model_output_file:
...
with open('../unilm/beit3/outputs/submit_vqav2_val1000_large_itc_annot.json', 'w') as updated_output_file:
