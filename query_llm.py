        ...
        if grader_id == 0:
            messages = [
                {"role": "system", "content": "Please grade the following answer provided by a large vision-language model (VLM) for a visual question answering task in one to two sentences. "
                              ...
                              "Partially correct is still '[Grader 0] [Correct]'. Otherwise, if the VLM's answer misses the targeted information, grade the answer as '[Grader 0] [Incorrect]'. Reason your grading step by step. "},
            ...
            messages = [
                {"role": "system", "content": "Evaluate the accuracy of a VLM's response to a visual question. "
                                              ...
                                              "Provide a rationale for your evaluation, highlighting the reasoning behind your decision. "},
            ...
            messages = [
                {"role": "system", "content": "Assess the response from a VLM on a visual question task. "
                                              ...
                                              "Justify your assessment step by step. "},
